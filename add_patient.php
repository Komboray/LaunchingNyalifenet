...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `patients` (FirstName, LastName, PhoneNumber, EmailAddress, NextOfKin, NextOfKinPhoneNumber, 
            ...
            AdditionalInformation, Password, rooms, date, statusLine, age) 
            ...
            '$medication', '$additionalInformation', '$password', '$rooms', CURRENT_DATE, '$statusLine', '$age')";
            ...
            try{
                ...
                if($response){
                    ...
                    echo '<script type="text/javascript">window.location.href="reception_index.php";</script>';
                ...
                if ($e->getCode() == 1062) { // 1062 is the MySQL error code for duplicate entry
                    ...
                    echo "<h1>The Phone number already exists, please try another number if the patient has never been to the hospital</h1>";
                } else {
